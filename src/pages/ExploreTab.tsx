...
const writings: Writing[] = [
  ...
  },
  {
    ...
    title: "Healing Hands",
    author: "Elena Torres",
    excerpt: "Two hands releasing a flock of golden birds into a twilight sky — symbolizing letting go of pain and embracing freedom.",
    image: artHealingHands,
  },
  {
    category: "stories",
    icon: BookOpen,
  ...
  },
  {
    ...
    author: "Marcus Hale",
    excerpt: "A figure walking uphill, their shadow shaped like heavy chains — yet flowers bloom from each footprint left behind.",
    image: artWeightWeCarry,
  },
  {
    category: "poems",
    icon: Feather,
  ...
  },
  {
    ...
    title: "Inner Garden",
    author: "Yuki Tanaka",
    excerpt: "A human silhouette filled with blooming wildflowers, roots intertwining with veins — representing growth from within.",
    image: artInnerGarden,
  },
  {
    category: "reflections",
    icon: Palette,
    ...
    author: "Community Member",
    excerpt: "I couldn't say it in words, so I painted it — dark blues that slowly bled into gold at the edges. My therapist said, 'That's what hope looks like.'",
  },
  {
    category: "art",
    icon: Palette,
    ...
    author: "Amara Osei",
    excerpt: "A face half-covered by cracking porcelain — underneath, warm light glows through the fractures, suggesting beauty in imperfection.",
    image: artBreakingThrough,
  },
];
        ...
        <div className="space-y-4">
          {filtered.map((w, i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-2xl bg-brown border border-brown/20 hover:shadow-md transition-all cursor-pointer animate-fade-in overflow-hidden"
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {isArt && (
                    <p className="text-brown-foreground/70 text-xs">{w.excerpt}</p>
                  )}
                  <div className="flex items-center gap-3 mt-3">
                    <button className="text-xs text-brown-foreground font-medium hover:underline">
                      {isArt ? "View full size" : "Read more"}
                    </button>
